...
ALTER TABLE pm_custom_archive_design
    ...
    MODIFY COLUMN archive_name VARCHAR(100) NOT NULL COMMENT '档案名称',
...
ALTER TABLE pm_custom_archive_item
    ...
    MODIFY COLUMN item_name VARCHAR(100) NOT NULL COMMENT '结果项名称',
...
ALTER TABLE pm_expense_detail_design
    ...
    MODIFY COLUMN detail_name VARCHAR(100) NOT NULL COMMENT '明细设计名称',
...
ALTER TABLE pm_document_expense_detail
    ...
    MODIFY COLUMN detail_title VARCHAR(200) NULL COMMENT '明细标题',
...
ALTER TABLE pm_process_flow
    ...
    MODIFY COLUMN flow_name VARCHAR(100) NOT NULL COMMENT '流程名称',
