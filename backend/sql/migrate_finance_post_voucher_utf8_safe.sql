...
FROM (
    SELECT
        'finance:general_ledger:post_voucher:view' AS permission_code,
        '记账' AS permission_name,
        'MENU' AS permission_type,
        'finance:general_ledger:menu' AS parent_code,
        'finance' AS module_code,
        '/finance/general-ledger/post-voucher' AS route_path,
        40135 AS sort_order
    UNION ALL
    SELECT
