...
CREATE TABLE gl_accvouch (
    ...
    maker_user_id BIGINT COMMENT '制单人用户ID',
    ...
    void_flag TINYINT COMMENT '作废标记',
    voided_at DATETIME COMMENT '作废时间',
    voided_by_user_id BIGINT COMMENT '作废人用户ID',
    voided_by_name VARCHAR(64) COMMENT '作废人名称',
    reversed_from_voucher_no VARCHAR(128) COMMENT '冲销来源凭证号',
    reversed_by_voucher_no VARCHAR(128) COMMENT '被哪张冲销凭证冲销',
    ...
    KEY idx_gl_accvouch_company_year_period_unified_no (company_id, iyear, iyperiod, ino_id),
