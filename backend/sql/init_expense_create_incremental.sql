...
CREATE TABLE IF NOT EXISTS pm_document_instance (
    ...
    template_name VARCHAR(64) NOT NULL COMMENT 'column comment',
    ...
    flow_name VARCHAR(64) NULL COMMENT 'column comment',
    submitter_user_id BIGINT NOT NULL COMMENT 'column comment',
    submitter_name VARCHAR(64) NOT NULL COMMENT 'column comment',
    document_title VARCHAR(128) NULL COMMENT 'column comment',
    ...
    current_node_name VARCHAR(64) NULL COMMENT 'column comment',
...
SET @sql = (
    SELECT IF(
        COUNT(*) = 0,
        'ALTER TABLE pm_document_instance ADD COLUMN current_node_name VARCHAR(64) NULL COMMENT ''column comment'' AFTER current_node_key',
        'SELECT 1'
    )
    FROM information_schema.COLUMNS
    WHERE TABLE_SCHEMA = DATABASE()
...
CREATE TABLE IF NOT EXISTS pm_document_action_log (
    ...
    actor_name VARCHAR(64) NULL COMMENT 'column comment',
    action_comment VARCHAR(500) NULL COMMENT 'column comment',
...
SET @sql = (
    SELECT IF(
        COUNT(*) = 0,
        'ALTER TABLE pm_document_task ADD COLUMN assignee_name VARCHAR(64) NULL COMMENT ''column comment'' AFTER assignee_user_id',
        'SELECT 1'
    )
    FROM information_schema.COLUMNS
    WHERE TABLE_SCHEMA = DATABASE()
