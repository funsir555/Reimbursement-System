...
- 本文属于系统设置 SQL / DDL 专题说明，仍为当前现行口径
- 当前进度与治理阶段请统一引用 `C:\Users\funsir\Desktop\报销系统\执行记录\报销系统治理落地方案.md`
- `SystemSettingsServiceImpl` 已进入 frozen facade 阶段；本文只维护 SQL 与权限目录说明，不再单独维护另一套项目进度
