...
INSERT INTO tmp_permission_seed (
    ...
    ('expense:voucher_generation:mapping:edit', '编辑凭证科目映射', 'BUTTON', 'expense:voucher_generation:view', 'expense', NULL, 3063, 1),
    ('expense:voucher_generation:push:view', '推送凭证', 'BUTTON', 'expense:voucher_generation:view', 'expense', NULL, 3064, 1),
    ('expense:voucher_generation:push:execute', '执行凭证推送', 'BUTTON', 'expense:voucher_generation:view', 'expense', NULL, 3065, 1),
    ('expense:voucher_generation:query:view', '凭证查询', 'BUTTON', 'expense:voucher_generation:view', 'expense', NULL, 3066, 1),
    ...
    ('finance:general_ledger:period_transfer:view', '期末结转', 'MENU', 'finance:general_ledger:menu', 'finance', '/finance/general-ledger/period-transfer', 40137, 1),
    ('finance:general_ledger:period_transfer:manage', '维护期末结转规则', 'BUTTON', 'finance:general_ledger:period_transfer:view', 'finance', NULL, 401371, 1),
    ('finance:general_ledger:period_transfer:generate', '生成期末结转凭证', 'BUTTON', 'finance:general_ledger:period_transfer:view', 'finance', NULL, 401372, 1),
    ...
    ('finance:general_ledger:detail_ledger:export', '导出明细账', 'BUTTON', 'finance:general_ledger:detail_ledger:view', 'finance', NULL, 40151, 1),
    ...
    ('finance:general_ledger:general_ledger:export', '导出总分类账', 'BUTTON', 'finance:general_ledger:general_ledger:view', 'finance', NULL, 40161, 1),
    ...
    ('finance:general_ledger:project_detail_ledger:export', '导出项目明细账', 'BUTTON', 'finance:general_ledger:project_detail_ledger:view', 'finance', NULL, 40171, 1),
    ...
    ('finance:general_ledger:supplier_detail_ledger:export', '导出供应商明细账', 'BUTTON', 'finance:general_ledger:supplier_detail_ledger:view', 'finance', NULL, 40181, 1),
    ...
    ('finance:general_ledger:customer_detail_ledger:export', '导出客户明细账', 'BUTTON', 'finance:general_ledger:customer_detail_ledger:view', 'finance', NULL, 40191, 1),
    ...
    ('finance:general_ledger:personal_detail_ledger:export', '导出个人明细账', 'BUTTON', 'finance:general_ledger:personal_detail_ledger:view', 'finance', NULL, 40201, 1),
    ...
    ('finance:general_ledger:quantity_amount_detail_ledger:export', '导出数量金额明细账', 'BUTTON', 'finance:general_ledger:quantity_amount_detail_ledger:view', 'finance', NULL, 40211, 1),
    ('finance:general_ledger:sequence_ledger:view', '序时账', 'MENU', 'finance:general_ledger:menu', 'finance', '/finance/general-ledger/sequence-ledger', 4022, 1),
    ('finance:general_ledger:sequence_ledger:export', '导出序时账', 'BUTTON', 'finance:general_ledger:sequence_ledger:view', 'finance', NULL, 40221, 1),
...
('finance:fixed_assets:view_voucher_link', '固定资产凭证联查', 'BUTTON', 'finance:fixed_assets:view', 'finance', NULL, 4029, 1),
    ...
    ('finance:archives:projects:create', '新增项目档案', 'BUTTON', 'finance:archives:projects:view', 'finance', NULL, 40461, 1),
    ('finance:archives:projects:edit', '编辑项目档案', 'BUTTON', 'finance:archives:projects:view', 'finance', NULL, 40462, 1),
    ('finance:archives:projects:disable', '启停项目档案', 'BUTTON', 'finance:archives:projects:view', 'finance', NULL, 40463, 1),
    ('finance:archives:projects:close', '封存项目档案', 'BUTTON', 'finance:archives:projects:view', 'finance', NULL, 40464, 1),
    ('finance:system_management:view', '财务系统管理', 'MENU', 'finance:menu', 'finance', '/finance/system-management', 405, 1),
    ('finance:system_management:create', '新建账套', 'BUTTON', 'finance:system_management:view', 'finance', NULL, 4051, 1),
    ('finance:system_management:task:view', '查看任务', 'BUTTON', 'finance:system_management:view', 'finance', NULL, 4052, 1),
    ('finance:system_management:enable', '系统启用开关', 'BUTTON', 'finance:system_management:view', 'finance', NULL, 4053, 1),
    ...
    ('agents:view', 'Agent工作台', 'MENU', 'agents:menu', 'agents', '/archives/agents', 551, 1),
    ('agents:create', '新建 Agent', 'BUTTON', 'agents:view', 'agents', NULL, 5511, 1),
    ('agents:edit', '编辑 Agent', 'BUTTON', 'agents:view', 'agents', NULL, 5512, 1),
    ('agents:delete', '删除 Agent', 'BUTTON', 'agents:view', 'agents', NULL, 5513, 1),
    ('agents:run', '运行 Agent', 'BUTTON', 'agents:view', 'agents', NULL, 5514, 1),
    ('agents:publish', '发布 Agent', 'BUTTON', 'agents:view', 'agents', NULL, 5515, 1),
    ('agents:view_logs', '查看运行日志', 'BUTTON', 'agents:view', 'agents', NULL, 5516, 1),
