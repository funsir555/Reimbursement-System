...
public final class AsyncTaskSupport {
    ...
    public static final String TASK_TYPE_FINANCE_OPENING_BALANCE_OPEN_BOOK = "FIN_OB_OPEN_BOOK";
    public static final String TASK_TYPE_FINANCE_OPENING_BALANCE_CARRY_FORWARD = "FIN_OB_CARRY_FORWARD";
